...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderBookmarks() {
    ...
    bookmarks.forEach(function (bookmark, index) {
      ...
      li.innerHTML = "\n            <a target=\"_blank\" href=\"".concat(bookmark.url, "\">").concat(bookmark.url, "</a>\n            <button class=\"edit\" data-index = \"").concat(index, "\">\u270E</button>\n            <button class=\"delete\" data-index = \"").concat(index, "\">X</button>\n            ");
  ...
  bookmarkList.addEventListener('click', function (event) {
    ...
    if (event.target.classList.contains('edit')) {
      var newUrl = prompt('Введіть нове посилання', bookmarks[index].url);
      if (newUrl) {
